                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="carp.php?id=JuniorPrograms">Adult Programs</a>
                            </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="crystalbeach.php?id=TennisLessons">Tennis Lessons</a>
                            </li>
                            <li><a href="crystalbeach.php?id=contact-form">Contact</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
